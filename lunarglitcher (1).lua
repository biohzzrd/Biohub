--[[
Lunar Glitcher V1.1
Scripted and animated by Iceyberg (whatsdez, siranticheat)
...
How to use:
Equip the hats
Replace the username variable to your in-game username (not display name)
If you are confident then you can try adjusting the config values

Update Logs:
Added 2 new modes (press 1 or 2)
Changed glasses to Nebula Blade
Added more config variables
Changed script name (originally the eye of skid)
]]

--// Change to your in-game name
local username = "whatsdez"

--//Config
local mode = 1
local speedMultiplier = 1
local offset = Vector3.new(0,5,5)
--// X,Y,Z don't do anything atm but DON'T delete or edit the values!
local x = 80
local y = 0
local z = 90
